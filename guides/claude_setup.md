...
**If user sees fewer than 30 tools:** The binary is stale (pre-v0.2.0). Run the reinstall commands from Step 2.
...
Next: open any FileMaker project folder and run /init-kibuild-project
to generate AI guide files (CLAUDE.md, AGENTS.md, GEMINI.md, Cursor rules).
```
